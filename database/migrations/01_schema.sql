...
DROP TABLE IF EXISTS enviromental_reading CASCADE;
...
-- This stores the enviroment readings
CREATE TABLE enviromental_reading (
  id SERIAL PRIMARY KEY,
...
-- This stores if the heater was on or off during the snap shot
